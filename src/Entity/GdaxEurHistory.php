...
/**
 * @ORM\Table(indexes={@ORM\Index(name="gdax_eur_idx", columns={"insert_time"})})
 * @ORM\Entity(repositoryClass="App\Repository\GdaxEurHistoryRepository")
 */
class GdaxEurHistory
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
