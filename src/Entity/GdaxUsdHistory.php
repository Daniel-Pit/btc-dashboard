...
/**
 * @ORM\Table(indexes={@ORM\Index(name="gdax_usd_idx", columns={"insert_time"})})
 * @ORM\Entity(repositoryClass="App\Repository\GdaxUsdHistoryRepository")
 */
class GdaxUsdHistory
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
