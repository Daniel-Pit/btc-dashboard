...
class BtcUsdController extends Controller
{
    /**
     * @Route("/btc/usd", name="btc_usd")
     */
    public function index()
    {

        $btc_usd_data = $this->getUsdViewData();
        $btc_usd_template = $this->getViewTemplate($btc_usd_data);

        return $this->render('btc_usd/index.html.twig', [
            'usdDataText' => $btc_usd_template,
            'usdData' => json_encode($btc_usd_data),
            'content_title' => "BTC - USD"
        ]);
    ...
    private function getUsdViewData($prevData=array()){

        $current_time = time();
        $merge_market_data = [];

        $prev_bitstamp_data = isset($prevData['Bitstamp'])?$prevData['Bitstamp']:array();
        $bitstamp_data = $this->getMarketUSDData($current_time, "Bitstamp", $prev_bitstamp_data);

        $prev_bitfinex_data = isset($prevData['Bitfinex'])?$prevData['Bitfinex']:array();
        $bitfinex_data = $this->getMarketUSDData($current_time, "Bitfinex", $prev_bitfinex_data);

        $prev_gdax_data = isset($prevData['GDAX'])?$prevData['GDAX']:array();
        $gdax_data = $this->getMarketUSDData($current_time, "GDAX", $prev_gdax_data);
    ...
    private function getMarketUSDData($current_time_interval, $market_name, $old_data=array()){
        ...
        $today_change = $this->getUSDChangePeriod($market_name, $current_spot, $current_time_interval, "0d");
        $today_high_low = $this->getUSDHighLowPeriod($market_name, $current_spot, $current_time_interval, "0d");
        $today_high = $today_high_low['high_value'];
        $today_low = $today_high_low['low_value'];

        $ago_24h_change = $this->getUSDChangePeriod($market_name, $current_spot, $current_time_interval, "1d");
        $ago_24h_high_low = $this->getUSDHighLowPeriod($market_name, $current_spot, $current_time_interval, "1d");
        $ago_24h_high = $ago_24h_high_low['high_value'];
        $ago_24h_low = $ago_24h_high_low['low_value'];


//        $ago_1w_change = $this->getUSDChangePeriod($market_name, $current_spot, $current_time_interval, "1w");
//        $ago_1w_high_low = $this->getUSDHighLowPeriod($market_name, $current_spot, $current_time_interval, "1w");
//        $ago_1w_high = $ago_1w_high_low['high_value'];
//        $ago_1w_low = $ago_1w_high_low['low_value'];
//
//        $ago_1m_change = $this->getUSDChangePeriod($market_name, $current_spot, $current_time_interval, "1m");
//        $ago_1m_high_low = $this->getUSDHighLowPeriod($market_name, $current_spot, $current_time_interval, "1m");
//        $ago_1m_high = $ago_1m_high_low['high_value'];
//        $ago_1m_low = $ago_1m_high_low['low_value'];
//
//        $ago_3m_change = $this->getUSDChangePeriod($market_name, $current_spot, $current_time_interval, "3m");
//        $ago_3m_high_low = $this->getUSDHighLowPeriod($market_name, $current_spot, $current_time_interval, "3m");
//        $ago_3m_high = $ago_3m_high_low['high_value'];
//        $ago_3m_low = $ago_3m_high_low['low_value'];
//
//        $ago_6m_change = $this->getUSDChangePeriod($market_name, $current_spot, $current_time_interval, "6m");
//        $ago_6m_high_low = $this->getUSDHighLowPeriod($market_name, $current_spot, $current_time_interval, "6m");
//        $ago_6m_high = $ago_6m_high_low['high_value'];
//        $ago_6m_low = $ago_6m_high_low['low_value'];
//
//        $ago_1y_change = $this->getUSDChangePeriod($market_name, $current_spot, $current_time_interval, "1y");
//        $ago_1y_high_low = $this->getUSDHighLowPeriod($market_name, $current_spot, $current_time_interval, "1y");
...
//        $ago_1y_low = $ago_1y_high_low['low_value'];
        ...
        $btcCacheMarketData = $this->getDoctrine()
            ...
            ->findMarketCurrencyData($market_name, "USD");
    ...
    private function getUSDHighLowPeriod($market_name, $current_value, $current_time_inteval, $period){
    ...
    private function getUSDChangePeriod($market_name, $current_value, $current_time_inteval, $period){
